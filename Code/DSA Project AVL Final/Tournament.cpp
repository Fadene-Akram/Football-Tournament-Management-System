...
void Tournament::SetTournamentGames(AvlTree<Game> &games)
{
    this->Games = games;
}
...
void Tournament::TournamentBestScorersList(const Date &date)
{
    ...
    AvlTree<PlayerStatistics> PlayerStatTree;
    std::cout << std::left;
...
{
    AvlTree<PlayerStatistics> PlayersTree;
    std::cout << std::left;
