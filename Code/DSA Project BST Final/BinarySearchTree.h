...
{
    Comparable element;
    BinaryNode<Comparable> *left = nullptr;
    BinaryNode<Comparable> *right = nullptr;
    BinaryNode(const Comparable& value, BinaryNode* l = nullptr, BinaryNode* r = nullptr)
            : element(value), left(l), right(r) {}


    BinaryNode(Comparable&& value, BinaryNode* l = nullptr, BinaryNode* r = nullptr)
            : element(std::move(value)), left(l), right(r) {}
};
